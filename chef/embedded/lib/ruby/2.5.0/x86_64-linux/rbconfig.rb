...
module RbConfig
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-rpath,/opt/chef/embedded/lib -L/opt/chef/embedded/lib -L/opt/chef/embedded/lib  -Wl,-rpath,/opt/chef/embedded/lib"
  CONFIG["ALLOCA"] = ""
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["LDFLAGS"] = "-L. -Wl,-rpath,/opt/chef/embedded/lib -L/opt/chef/embedded/lib -fstack-protector -rdynamic -Wl,-export-dynamic -L/opt/chef/embedded/lib  -Wl,-rpath,/opt/chef/embedded/lib"
